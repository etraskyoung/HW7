...
class Cohort:
    def __init__(self, id, pop_size, mortality_prob):
        ...
        self._patients_alive_after_5_years = 0 # count of patients alive after 5 years
    ...
    def simulate(self, n_time_steps):
        ...
        for patient in self._patients:
            if patient.get_survival_time() > 5:
                self._patients_alive_after_5_years += 1

        # return cohort outcomes for this simulated class
        return CohortOutcomes(self)

    def get_patients_alive_after_5_years(self):
        return self._patients_alive_after_5_years
...
class CohortOutcomes:
    ...
    def get_percent_alive_after_5_years(self):
        return self._simulatedCohort.get_patients_alive_after_5_years()/self._simulatedCohort.get_initial_pop_size()
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._percent_alive_after_five_years_cohort = []
        self._sumStat_meanSurvivalTime = None
        self._sumStat_Percent_alive_after_5_years = None
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            # store % alive after 5 years for this cohort
            self._percent_alive_after_five_years_cohort.append(output.get_percent_alive_after_5_years())
        ...
        self._sumStat_percent_alive_after_5_years = Stat.SummaryStat ('Mean % alive after 5 years', self._percent_alive_after_five_years_cohort)
    ...
    def get_overall_percentage_alive_after_5_years(self):
        # returns overal average of percentage alive after 5 years
        return self._sumStat_percent_alive_after_5_years.get_mean()
